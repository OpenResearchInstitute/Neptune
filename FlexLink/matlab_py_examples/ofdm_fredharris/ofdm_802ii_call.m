...
% data_x=rand(30,52);
% data_y=rand(30,52);
% save('data_x.txt', "data_x", '-ascii');
% save('data_y.txt', "data_y", '-ascii');

% use this if files is present
load('data_x.txt', "data_x");
load('data_y.txt', "data_y");
...
for mm=1:30
    ...
    dx1=(floor(4*data_x(mm,:))-1.5)/1.5;
    dy1=(floor(4*data_y(mm,:))-1.5)/1.5;
