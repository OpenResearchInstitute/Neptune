...
%'emlmex' has been removed. With appropriate code changes, use 'codegen' instead.
codegen -o radix4FFT3_MX -eg {sfi}  radix4FFT3_FixPtEML
%requires toolboxes on Keroppi 
